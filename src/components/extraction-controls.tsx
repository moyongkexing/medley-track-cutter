        ...
        <div className="space-y-4">
          ...
          >
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="use-spectral" className="font-medium">
                曲の特徴を分析して分割
              </Label>
            ...
            <div className="flex items-center space-x-2">
              <RadioGroupItem
                ...
                disabled={isProcessing || !hasAudioFile}
              />
              <Label htmlFor="use-silence" className="font-medium">
                無音区間で分割
              </Label>
          ...
          {trackOptions.useSpectralDetection && (
            <div className="ml-6 space-y-4 border-l-2 border-gray-200 pl-4 mt-4">
              <div>
                <Label htmlFor="spectrum-sensitivity">
                  分割感度: {trackOptions.spectralOptions.sensitivity?.toFixed(1)}
                </Label>
                <Slider
                ...
                <p className="text-xs text-gray-500">
                  高いほど小さな変化も検出しますが、過剰検出する可能性があります。
                </p>
              </div>
              ...
              <div>
                ...
                />
                <p className="text-xs text-gray-500">
                  この秒数以上の間隔が必要です（あまり短くすると過剩検出します）。
                </p>
              </div>
            </div>
          )}
            ...
            <div className="ml-6 space-y-4 border-l-2 border-gray-200 pl-4 mt-4">
              <div>
                <Label htmlFor="silence-threshold">
                  無音レベル閾値: {trackOptions.silenceOptions.silenceThreshold} dB
                </Label>
                <Slider
                ...
                />
                <p className="text-xs text-gray-500">
                  低いほど（-80に近いほど）より小さな音まで音として検出します。
                </p>
              </div>
          ...
          <Button
            ...
            disabled={
              isProcessing ||
              !hasAudioFile ||
              (!trackOptions.useSilenceDetection && !trackOptions.useSpectralDetection)
            }
